...
<head>
    ...
    <title><decorator:title default=""/> - monitor</title>
        ...
        <div class="col-xs-12">
            <nav class="navbar navbar-inverse navbar-embossed" role="navigation">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${contextPath}/">池乐-monitor</a>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse-01">
                    <ul class="nav navbar-nav navbar-left" id="mainMenu">
                        ...
                        <li class="dropdown" id="systemMenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><spring:message
                                    code="main.jsp.thread" text="Thread"/> <b
                                           
                                    class="caret"></b></a>
                            <span class="dropdown-arrow"></span>
                            <ul class="dropdown-menu">
                                <%--<sec:authorize ifAnyGranted="ROLE_CREATE_EDIT_INSTANCE">--%>
                                <li><a href="${contextPath}/system/instance_form.hb"><spring:message
                                        code="main.jsp.new.thread" text="New Thread"/></a></li>
                                <%--</sec:authorize>--%>
                                <li><a href="${contextPath}/system/list.hb"><spring:message code="main.jsp.threads"
                                                                                              text="Threads"/></a>
                                </li>
                            </ul>
                        </li>
