                ...
                function (ec) {
                    ...
                    var option${s.index} = {
                        title: {
                            ...
                            subtext: '<spring:message code="index.jsp.frequency" text="Frequency"/>: ${ins.frequency.label}  <spring:message code="index.jsp.max.conn" text="Max-Conn"/>: ${ins.maxConnectionSeconds}s <spring:message code="index.jsp.request.method" text="Request-Method"/>: ${ins.requestMethod} <spring:message code="index.jsp.failed.time" text="ContinueFailedTimes"/>: ${ins.continueFailedTimes}'
                        },
                        tooltip: {
                            trigger: 'axis'
                        },
