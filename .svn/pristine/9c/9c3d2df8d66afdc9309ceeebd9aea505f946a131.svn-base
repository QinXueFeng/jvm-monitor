        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <spring:message code="monitoring.instance.jsp.frequency" text="Frequency"/>: <span
                    class="text-info">${instanceDto.frequency.label}</span>
            </li>
            <li class="list-group-item">
            ...
            function (ec) {
                ...
                var option0 = {
                    title: {
                        ...
                        subtext: '<spring:message code="monitoring.instance.jsp.frequency" text="Frequency"/>: ${instanceDto.frequency.label}  <spring:message code="monitoring.instance.jsp.max.conn2" text="Max-Conn"/>: ${instanceDto.maxConnectionSeconds}s <spring:message code="monitoring.instance.jsp.request.method" text="Request-Method"/>: ${instanceDto.requestMethod} <spring:message code="index.jsp.failed.time" text="ContinueFailedTimes"/>: ${instanceDto.continueFailedTimes}'
                    },
                    tooltip: {
                        trigger: 'axis'
                    },
